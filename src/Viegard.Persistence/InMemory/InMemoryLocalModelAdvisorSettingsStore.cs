        ...
        CancellationToken cancellationToken = default)
    {
        ...
        lock (_sync)
        {
            ...
            _settings = _settings with
            {
                ...
                DeEscalationEnabled = normalized.DeEscalationEnabled,
                MaxDownwardSeverityDelta = normalized.MaxDownwardSeverityDelta,
                MaxDownwardConfidenceDelta = normalized.MaxDownwardConfidenceDelta,
                DeEscalationMinModelConfidence = normalized.DeEscalationMinModelConfidence,
                DeEscalationProtectedSeverity = normalized.DeEscalationProtectedSeverity,
