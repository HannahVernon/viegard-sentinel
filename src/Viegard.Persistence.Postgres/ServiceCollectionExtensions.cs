...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddViegardPostgresPersistence(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<IAppPasswordStore, PostgresAppPasswordStore>();
        ...
        services.AddSingleton<Viegard.Application.Doh.IDohReconciliationProposalStore, PostgresDohReconciliationProposalStore>();
        services.AddSingleton<Viegard.Application.Doh.IDohProbeSummaryStore, PostgresDohProbeSummaryStore>();
        services.AddSingleton<Viegard.Application.Doh.IDohProbeTrigger, PostgresDohProbeTrigger>();
