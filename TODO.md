...
- [ ] **Phase 7: Actions** - DECIDED 2026-09-16 (D-0038): increment one is manual-approval network enforcement.  Build order:
  - [ ] **Policy thresholds /configuration slice**: review severity/confidence and unattended confidence seeded from env, UI-edited, LISTEN/NOTIFY to the policy engine (D-0029 slice).
